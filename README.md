...
OpenSCAD script to generate 3D model with blueprints for a custom storage shelving inspired by IKEA Kallax.
...
You will have to provide a link to the original creator of the project http://anavi.org on any documentation or website.

Credit can be attributed through a link to the creator website: http://anavi.org
